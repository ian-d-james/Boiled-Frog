...
<html>
	<head>
 		<title>Boiled Frog - Climate Change Accountability</title>
			...
			<section id="One" class="wrapper style3">
				<div class="inner">
					<header class="align-center">
						<p>Accountability</p>
						<h2>Political, Corporate and Educational Accountability</h2>
					</header>
				</div>
			</section>
				...
				<div class="inner">
					<div class="box">
						<div class="content">
							...
							<div style="float:left; margin-right:20px;"><iframe width="560" height="315" src="https://www.youtube.com/embed/VFkQSGyeCWg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
							...
							<header class="align-center">
									...
									<h3>Action springs not from thought, but from a readiness for responsibility.</h3>
								</header>
